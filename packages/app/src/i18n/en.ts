export const dict = {
  ...
  "command.agent.infinite": "Toggle infinite mode",
  "command.agent.infinite.description": "Enable or disable infinite auto-followup mode",
  ...
  "settings.general.row.autoFollowup.title": "Auto follow-up",
  "settings.general.row.autoFollowup.description": "Automatically send a prompt after the assistant completes",
  "settings.general.row.autoFollowupPhrase.title": "Follow-up phrase",
  "settings.general.row.autoFollowupPhrase.description": "Custom phrase to send automatically",
